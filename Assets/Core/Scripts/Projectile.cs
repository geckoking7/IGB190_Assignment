...
public class Projectile : MonoBehaviour
{
    ...
    /// </summary>
    public void Setup(IVisualCodeHandler handler)
    {
    ...
    /// </summary>
    private void AssignProjectileOwnership(IVisualCodeHandler handler)
    {
    ...
    {
        return (GameManager.assets.wallMask.value & (1 << other.gameObject.layer)) != 0;
        //GameManager.assets.wallMask.
        //return (other.gameObject.layer == LayerMask.NameToLayer(VisualCodeLabels.Layers.Wall));
    }
    ...
    {
        GameManager.events.OnProjectileWallCollision.Invoke(new GameEvents.OnProjectileWallCollisionInfo(engineHandler, owner, this, transform.position));
    }
    ...
    {
        GameManager.events.OnProjectileCollision.Invoke(new GameEvents.OnProjectileCollisionInfo(engineHandler, owner, this, enemy));
    }
    ...
    {
        GameManager.events.OnProjectileGoalReached.Invoke(new GameEvents.OnProjectileGoalReachedInfo(engineHandler, owner, this, targetUnit, targetPosition));
        DestroyProjectile();
    }
    ...
    {
        GameManager.events.OnProjectileTimeout.Invoke(new GameEvents.OnProjectileTimeoutInfo(engineHandler, owner, this));
        DestroyProjectile();
    }
}
